...
<head>
  ...
  <style>
    :root{
      ...
      --pink-2:#db2777;       /* deeper */
      --focus:#f472b6;        /* focus ring */
    ...
    *{box-sizing:border-box}
    ...
    .input{
      ...
      background:#fafafa; color:var(--ink); font-size:15px; transition:border-color .2s, background .2s, box-shadow .2s;
    }
    .input:focus{
    ...
    .btn{
      width:100%; padding:12px 14px; border:0; border-radius:12px; cursor:pointer; font-weight:800; font-size:15px;
    ...
    /* Optional alerts (use from server if needed) */
    .note{font-size:13px; margin-top:8px; color:#9ca3af}
...
<body>
  <div class="page">
    <div class="card">
      ...
      <!-- Optional server alert example:
      <div class="alert success">We’ve emailed you a reset link.</div>
      <div class="alert error">No account found with that email.</div>
      -->
